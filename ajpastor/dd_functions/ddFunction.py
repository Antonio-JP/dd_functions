...
from ajpastor.misc.ring_w_sequence import Ring_w_Sequence, Wrap_w_Sequence_Ring, sequence
...
class DDRing (Ring_w_Sequence, IntegralDomain, SerializableObject):
    ...
    def _coerce_map_from_(self, S):
        ...
        if(isinstance(S, DDRing)):
            ...
            coer = True
        elif(isinstance(S, SymbolicRing)):
            coer = True
        else:
...
class DDFunction (IntegralDomainElement, SerializableObject):
    ...
    def compose(self, other):
        ...
        if(isinstance(other.parent(), SymbolicRing)):
            try:
    ...
    def __eq__(self,other):
        if (other is self):
            return True
        if((type(other) == Integer or type(other) == int) and other == 0 ):
            return self.is_null
