...
# ****************************************************************************
# Some needed imports
from sage.all import (FieldElement, Field, IntegralDomains, UniqueRepresentation)
...
from .lazyIDElements import LazyIDElement, SumLIDElement, LazyIntegralDomain, LazyDomain
...
class LazyFracFieldFunctor (ConstructionFunctor):
    def __init__(self):
        self.rank = 25
        super(LazyFracFieldFunctor, self).__init__(_IntegralDomains,_QuotientFields)
